    ...
    <div className="my-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4  gap-4 px-4">
        {products.map((product) => (
          <div key={product.id} className=" bg-orange-100 rounded-xl border border-solid border-stone-950 p-2 text-left">
            <img src={product.image} alt={product.name}  className="rounded-xl w-full mx-auto"/>
